...
class VideoAdapter (options: FirestorePagingOptions<Video>, private val glide: RequestManager) : FirestorePagingAdapter<Video, VideoAdapter.FeaturedViewHolder>(options) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeaturedViewHolder {
        return FeaturedViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_video, parent, false))
    }
